...
public class QuestionBlock : MonoBehaviour
{
    ...
    void PresentCoin()
    {
        ...
        spinningCoin.transform.localPosition = new Vector2(originalPosition.x, originalPosition.y + 1f);
    ...
    IEnumerator MoveCoin(GameObject coin)
    {
        while(true)
        {
            ...
            if (coin.transform.localPosition.y >= originalPosition.y + coinMoveHeight + 1f)
                break;
            yield return null;
        }
        while(true)
        {
            ...
            if (coin.transform.localPosition.y <= originalPosition.y + coinFallDistance + 1f)
            {
